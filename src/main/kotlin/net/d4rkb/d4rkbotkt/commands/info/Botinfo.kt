...
class Botinfo : Command(
    ...
    override fun run(ctx: CommandContext) {
        ...
        val embed = EmbedBuilder()
            ...
            .addField("<a:infinity:838759634361253929> Uptime", "`${Utils.msToDate(ManagementFactory.getRuntimeMXBean().uptime)}`", true)
            .addField(":desktop: Servidores", "`${ctx.jda.guilds.size}`", true)
            .addField(":ping_pong: Ping", "`${ctx.jda.gatewayPing}`", true)
            .addField("<:badgehypesquad:803665497223987210> Prefixos", "`dk.`", true)
            .addField("<:ram:751468688686841986> RAM", "Alocada: `${runtime.totalMemory() / 1024 / 1024}MB`\n" +
                    "Usada: `${(runtime.totalMemory() - runtime.freeMemory()) / 1024 / 1024}MB`", true)
